...
SELECT listings.property_type, count(listings.property_type), max(reviews.date_reviewed) FROM listings INNER JOIN reviews ON listings.id = reviews.listing_id GROUP BY listings.property_type;
